...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#050d1a] border-t border-white/[0.06]">
        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-slate-400 text-sm leading-relaxed mb-6 max-w-xs">
              Australia's premier international labour recruitment company.
              Sourcing qualified trade and industrial talent from our Manila hub
              for mining, construction, and manufacturing projects.
            </p>
            ...
            <div className="space-y-3 mb-6">
              ...
              >
                ...
                <span className="text-sm">
                  admin@globalworkforcesolutions.com.au
                </span>
              </a>
            </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2 bg-white/[0.03] border border-white/[0.06] rounded-lg px-3 py-1.5">
              ...
              <span className="text-slate-600 text-xs">
                Modern Slavery Act 2018 Compliant
              </span>
            </div>
